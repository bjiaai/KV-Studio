...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    {
      name: 'feishu_auth',
      title: t('groups.feishu_auth'),
      description: 'custom your feishu auth settings',
      tab: 'auth',
    },
    {
      name: 'github_auth',
    ...
    },
    {
      name: 'openai',
      title: 'OpenAI',
      description: 'OpenAI compatible endpoint settings',
      tab: 'ai',
    },
    {
      name: 'replicate',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      tip: 'Set any OpenAI compatible API URL, e.g. http://127.0.0.1:8045/v1 for Antigravity',
      group: 'openai',
      tab: 'ai',
    },
    {
    ...
    },
    {
      ...
      group: 'gemini',
      tip: 'Set a custom Gemini REST endpoint, e.g. http://127.0.0.1:8045 for Antigravity proxy',
      tab: 'ai',
    },
    {
      name: 'kie_api_key',
